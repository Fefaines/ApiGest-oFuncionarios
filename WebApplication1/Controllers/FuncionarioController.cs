...
namespace WebApplication1.Controllers
{
    ...
    public class FuncionarioController : ControllerBase
    {
        ...
        //Requisição que retorna todos os funcionarios
        [HttpGet]
        ...
        //Requisição que retorna um funcionario pelo id
        [HttpGet("{id}")]
        ...
        //Requisição que cria um novo funcionario e retorna a lista de funcionarios atualizada
        [HttpPost]
